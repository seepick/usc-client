    ...
    init {
        "When parse booked activities Then return entries" {
            ...
            schedule shouldBeEqual listOf(
                BookedOrScheduled(84742854, "studio-108-3", ScheduleEntityType.Activity),
                BookedOrScheduled(84726253, "yoga-spot-olympisch-stadion", ScheduleEntityType.Activity),
                BookedOrScheduled(84810748, "movements-city", ScheduleEntityType.Activity),
            )
        }
        "When parse scheduled freetraining Then return entry" {
            ...
            schedule shouldBeEqual listOf(
                BookedOrScheduled(83664089, "vitality-spa-fitness-amsterdam", ScheduleEntityType.Freetraining),
            )
        }
    }
}
